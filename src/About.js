...
function About() {
  return (
   ...
   <div className='about-text'> With each brushstroke, I felt a dialogue unfolding, a deeper understanding of both the world around me and the emotions within. Ruby is gone now, as is my time in Liverpool. But my journey has led me to a new land, where the veil between the seen and unseen feels thin, and the landscape's beauty holds a profound mystery. Here, I've come to understand that this path, this connection to nature, is no accident—it's the journey I was always meant to take.
